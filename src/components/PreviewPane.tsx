...
export const PreviewPane: React.FC<Props> = ({ project, mobile, dark }) => {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="border rounded p-2 bg-white overflow-auto" style={{background: dark? '#333':'#fafafa'}}>
        <style dangerouslySetInnerHTML={{__html: css}} />
        <div id="workskin" style={{width: mobile? 375: '100%', maxWidth: '100%', transition: 'width .2s', margin: '0 auto'}} dangerouslySetInnerHTML={{__html: html}} />
      </div>
    </div>
  );
};
